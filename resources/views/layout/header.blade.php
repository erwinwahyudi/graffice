            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.html" class="logo"><i class="md md-quick-contacts-mail icon-c-logo"></i><span>E-<i class="md md-album"></i>ffice</span></a>
                        <!-- Image Logo here -->
                        <!--<a href="index.html" class="logo">-->
                            <!--<i class="icon-c-logo"> <img src="{{ asset('images/logo_sm.png') }}" height="42"/> </i>-->
                            <!--<span><img src="{{ asset('images/logo_light.png') }}" height="20"/></span>-->
                        <!--</a>-->
                    </div>
                </div>
